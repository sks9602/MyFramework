Ext.define('Ext.calendar.data.HolidayModel', {
    ...
    statics: {
        ...
        reconfigure: function(){
            var Data = Ext.calendar.data,
                Mappings = Data.HolidayMappings,
                proto = Data.HolidayModel.prototype,
                fields = [];
            ...
            proto.idProperty = Mappings.HolidayId.name || 'id';
            ...
            return Data.HolidayModel;
        }
    }
},
function() {
    Ext.calendar.data.HolidayModel.reconfigure();
});