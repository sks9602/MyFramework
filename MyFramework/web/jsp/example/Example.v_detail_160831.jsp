...
<jun:body title="상세내용" pageIndex="<%= TAB_INDEX %>">
	<jun:form id="detail_1" action="/example/example.do" title="상세정보" button="저장,삭제">
		...
		<jun:itemGrid  type="grid"  title="제목">
			<jun:grid action="/example/example.do" width="500" height="200" button="추가,삭제"  id="detail_grid_1" page="5" fields="Sample.selectTableList">
				<jun:columns>
		...
		<jun:itemGrid  type="grid"  title="제목2">
			<jun:grid action="/example/example.do" width="500" height="200"  button="저장"  id="detail_grid_2" page="5" fields="Sample.selectTableList">
				<jun:columns>
					<jun:column title="성명" column="NAME" ></jun:column>
					<jun:column title="샘플" column="MEMBER_NO" ></jun:column>
				</jun:columns>
