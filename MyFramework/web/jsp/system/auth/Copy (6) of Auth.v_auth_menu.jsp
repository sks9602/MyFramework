...
<jun:functions  targetId="detail_1">
	...
	<jun:function action="삭제"  comments="권한 삭제">
		...
		form.submit({
			'msgTxt' : '['+ form.getFieldValue('AUTH_NM') + '] 권한에 해당하는 모든 메뉴 및 운영자 정보가 삭제 됩니다.<br/>그래도 삭제 하시겠습니까?',
...
<jun:body pageIndex="<%= TAB_INDEX %>">
	<jun:data>
		<jun:form section="search"  button="조회" gridId="grid_1" position="north" maxItem="4" id="search">
			...
			<jun:itemCode  type="combo"   name="AUTH_CD"  title="권한 구분"  groupCode="Code.selectAuthCode"></jun:itemCode>
		...
		<jun:data>
			...
			<jun:form title="권한 정보" action="/system/auth.do" button="초기화,상세정보저장,삭제" id="detail_1" position="south" maxItem="4">
