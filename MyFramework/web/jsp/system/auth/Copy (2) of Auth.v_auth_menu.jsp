...
<jun:body pageIndex="<%= TAB_INDEX %>">
	...
	<jun:data layout="accordion" id="east"  position="east" title="*좌측의 목록에서 [권한 구분]을 클릭하세요."  width="860">
		...
		<jun:grid id="grid_2" title="권한 대상자 현황" action="/system/auth.do" actionFlag="b_mergeList" page="1" fields="Auth.selectAuthList">
			<jun:columns>
				<jun:column title="권한 구분" column="AUTH_NM"  width="150"  editor="link" align="left">
					renderer : function (value, p, record){
						return Ext.String.format(
