...
public class HoValidator extends GenericValidator {
	...
	public static boolean maxDBLength(String value, int max) {
		return maxDBLength(value, max, 2);
	}


	public static boolean maxDBLength(String value, int max, int charLength) {
	 ...
	 */
	public static boolean isIn(String [] compareString, String str) {
		if( str == null ) {
			return false;
		}
	...
	/*
	 * 문자열이 비교문자열(대소문자 구분 없이)에 존재하는지 확인
	 */
	public static boolean isIn( String [] compareString, String str,boolean ignoreCase) {
		if( str == null ) {
			return false;
		}
		for( int i=0 ; i<compareString.length ; i++ ) {
			if( str.equalsIgnoreCase(compareString[i])) {
				return true;
			}
		}
	 ...
	 * 문자열이 비교문자열(대소문자 구분 없이)에 존재하는지 확인
	 */
	public static boolean isIn(String str, String [] compareString, boolean ignoreCase) {
		if( str == null ) {
			return false;
		}
		for( int i=0 ; i<compareString.length ; i++ ) {
